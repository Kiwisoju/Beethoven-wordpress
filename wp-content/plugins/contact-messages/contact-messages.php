...
class ContactLogs{
    ...
    public function __construct(){
        ...
        add_action('wp_ajax_some_action', array(&$this, 'ajax_some_action') );
        add_action('wp_ajax_nopriv_some_action', array(&$this, 'ajax_some_action') );
    ...
    public function ajax_some_action(){
        die(json_encode(array('message'=>'my hovercraft is full of EELS!!')));
    }
...
register_activation_hook(__FILE__, array(&$contactLogs, 'install') );
//This hooks onto the action of deactivating your plugin
register_deactivation_hook(__FILE__, array(&$contactLogs, 'uninstall') );